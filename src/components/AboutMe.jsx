      ...
      <div className="about-me">
        <div className="about-me__content">
          ...
          <div className="about-me__images">
            <img className="about-me__image about-me__image_area_1" src={image1} />
            <img className="about-me__image about-me__image_area_2" src={image2} />
            <img className="about-me__image about-me__image_area_3" src={image3} />
          </div>
        </div>
      </div>

      <div className="showreels">
        <div className="showreels__button" link="https://youtu.be/CUmPh7tNeTI" onClick={handleClick}>VIEW COMPOSITING SHOWREEL<div
